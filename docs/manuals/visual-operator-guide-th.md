...
> เมื่อแถบด้านบนเขียนว่า “โหมดข้อมูลตัวอย่างในเครื่อง” ระบบจะแสดงข้อมูลสังเคราะห์
> และการกดบันทึกจะแสดงขั้นตอนให้ทดลอง แต่จะไม่เขียนข้อมูลลงเซิร์ฟเวอร์
...
3. ที่กรอบ **2** กรอกเลขที่ใบรับ แล้วกด “เปิดใบรับ”
...
3. ที่กรอบ **2** ผู้ใช้คนที่สองเลือกใบตรวจที่รออนุมัติ แล้วกด “อนุมัติผลนี้”
...
3. ที่กรอบ **2** ตรวจสอบคำแนะนำก่อนยืนยันตำแหน่งที่เลือกจริง
...
- ในโหมดข้อมูลตัวอย่าง ให้ถือผลเป็นการสาธิตเท่านั้น เพราะระบบไม่เก็บข้อมูล
- ในระบบจริง หากได้รับข้อความปฏิเสธ ให้บันทึกรหัสคำขอไว้สำหรับฝ่ายสนับสนุน

## การปรับปรุงภาพประกอบ

ภาพต้นฉบับและกรอบ SVG สร้างซ้ำได้ด้วยคำสั่ง:

```sh
node scripts/generate-operator-manual-assets.mjs
```

คำสั่งจะอ่านภาพจากโฟลเดอร์ `../industrial-sas-visual-audit/after-final` โดยปริยาย
หรือระบุพาธโฟลเดอร์ภาพเป็นอาร์กิวเมนต์แรกเมื่อตำแหน่งไฟล์ต่างออกไป
