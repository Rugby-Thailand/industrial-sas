...
| `masterData.storageLayout.read`     | WH    | Read storage building and floor layouts         | —                      |
| `masterData.storageLayout.manage`   | WH    | Create and edit draft storage layouts           | —                      |
| `masterData.storageLayout.activate` | WH    | Activate or archive a validated storage layout  | —                      |
...
| `masterData.storageLayout.read`     | Y         | Y                 |            |          |              |                  |                   |        |                        |          |                      |                    |
| `masterData.storageLayout.manage`   | Y         | Y                 |            |          |              |                  |                   |        |                        |          |                      |                    |
| `masterData.storageLayout.activate` | Y         | Y                 |            |          |              |                  |                   |        |                        |          |                      |                    |
