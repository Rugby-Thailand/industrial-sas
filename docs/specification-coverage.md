...
| `SC-Q12` | Static: no exported function bypasses the wrapper      | Not present                                             | `RG-032` | Not implemented |
| `SC-Q13` | Static: no mutation updates or deletes ledger/audit    | Not present                                             | `RG-033` | Not implemented |
