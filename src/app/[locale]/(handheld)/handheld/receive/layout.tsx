...
/**
 * The client message scope for the handheld receive task.
 *
 ...
 */
export default async function HandheldReceiveLayout({
  children,
  params,
}: {
  ...
  return (
    <RouteMessages scope="(handheld)/handheld/receive" locale={locale}>
      {children}
    </RouteMessages>
  );
}
