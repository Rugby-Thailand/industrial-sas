...
const PREVIEW_ORDERS: readonly ProductionOrderRow[] = [
  {
    productionOrderId: "prv_mo_26018",
    warehouseId: "prv_wh_bangpoo",
    productionOrderNumber: "MO-26018",
    factoryPacketId: "prv_packet_26018_1",
    customerOrderLineId: "prv_sol_26018_1",
    fulfillmentLineId: "prv_ff_line_26018_1",
    planningSource: "ROUTED_SHORTAGE",
    masterCardRevisionId: "prv_rev_4",
    revisionNumber: 4,
    outputItemId: "prv_item_carton_a",
    outputBaseUom: "EA",
    targetBaseMinorUnits: 2_400_000,
    quantities: {
      target: 2_400_000,
      good: 2_100_000,
      scrap: 200_000,
...
const PREVIEW_IMPACTS: readonly DesignChangeImpactRow[] = [
  {
    designChangeImpactId: "prv_impact_rev_5_mo_26018",
    warehouseId: "prv_wh_bangpoo",
    masterCardId: "prv_mc_gold_991",
    fromRevisionId: "prv_rev_4",
    toRevisionId: "prv_rev_5",
    productionOrderId: "prv_mo_26018",
    productionOrderNumber: "MO-26018",
    productionOrderStatus: "QC_PENDING",
    severity: "BLOCKING",
    changedFields: ["internalWidthMm", "materials"],
    categories: ["DIMENSIONS", "MATERIALS"],
    status: "OPEN",
    createdByUserId: "prv_engineering_approver",
    ...
    <QueryGate scope="WAREHOUSE">
      {(warehouseId, preview) =>
        preview ? (
          ...
          <ServerProductionWorkspace warehouseId={warehouseId} />
        )
      }
    </QueryGate>
  );
        ...
        <EntityWriteForm
          ...
          fields={[
            ...
            },
            {
              ...
              monospace: true,
              ...(preview
                ? { initialValue: "prv_material_requirement_1" }
                : {}),
            },
            {
          ...
          fields={[
            {
              ...
              required: true,
              monospace: true,
              ...(preview ? { initialValue: "prv_output_receipt_1" } : {}),
            },
            {
              name: "decision",
              label: t("decision"),
